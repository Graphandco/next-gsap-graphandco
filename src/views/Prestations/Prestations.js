      ...
      <section className="prestations">
        ...
        <div className="prestations__lead container">
          ...
          <FadeInOut y={-20} delay={1.8} className="prestations__lead__content">
            Nous mettons à votre disposition le site qui vous correspond le
            mieux. Nous adaptons nos prestations en fonction de vos besoins.
            Choisissez votre pack, tout est personnalisable afin de convenir à
            vos attentes, qu'il s'agisse d'un site vitrine classique ou d'un
            site avec des fonctionnalités plus poussées, nous avons forcément le
            site taillé pour vous !
          </FadeInOut>
        </div>
        <div className="prestations__hero container">
          <div className="prestations__hero__row">
            ...
            <FadeInOut y={5} delay={2.25}>
              Vous êtes novice en informatique ? Aucun problème, nous vous
              montrons à quel point éditer votre site est un vrai jeu d'enfant !
            </FadeInOut>
          </div>
          <div className="prestations__hero__row">
            ...
            <FadeInOut y={5} delay={2.75}>
              Vous êtes un utilisateur aguerri ? Vous serez ravi du niveau de
              personnalisation que le site vous propose.
            </FadeInOut>
          </div>
        </div>

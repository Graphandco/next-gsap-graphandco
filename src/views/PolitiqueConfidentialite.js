    ...
    <>
      <section className="politique-confidentialite">
        <Pagetitle
          ...
          bodyID="politique-confidentialite"
        />
        <FadeInOut x={-20} delay={1.8}>
          <section className="politique-confidentialite container">
            ...
            <div className="mention">
              ...
              <p>
                Une chaîne anonymisée créée à partir de votre adresse de
                messagerie (également appelée hash) peut être envoyée au service
                Gravatar pour vérifier si vous utilisez ce dernier. Les clauses
                de confidentialité du service Gravatar sont disponibles ici :{" "}
                <a
                  title="Politique Gravatar"
                  href="https://automattic.com/privacy/"
                >
                  https://automattic.com/privacy/
                </a>
                . Après validation de votre commentaire, votre photo de profil
                sera visible publiquement à coté de votre commentaire.
              </p>
            </div>
            <div className="mention">
              <h2>Médias</h2>
              <p>
                Si vous êtes un utilisateur ou une utilisatrice enregistré·e et
            ...
            <div className="mention">
              ...
              <p>
                En nous contactant via le formulaire de contact, vous acceptez
                d’être recontacté par mail
              </p>
            </div>
            <div className="mention">
              <h2>Cookies</h2>
              ...
              <p>
                Si vous avez un compte et que vous vous connectez sur ce site,
                un cookie temporaire sera créé afin de déterminer si votre
                navigateur accepte les cookies. Il ne contient pas de données
              ...
              <p>
                ...
                supplémentaire sera enregistré dans votre navigateur. Ce cookie
                ne comprend aucune donnée personnelle. Il indique simplement
                l’ID de la publication que vous venez de modifier. Il expire au
                bout d’un jour.
              </p>
            </div>
            <div className="mention">
            ...
            <div className="mention">
              ...
              <p>
                Dans le but d’améliorer notre site et d’avoir des infos
                concernant l’audience, nous collectons des informations liées au
                trafic sur ce dernier.
              </p>
            </div>
          </section>
        </FadeInOut>
